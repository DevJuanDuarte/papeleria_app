...
<template>
    ...
    <AuthenticatedLayout>
                ...
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tbody class="bg-white divide-y">
                        <tr v-for="b, i in books.data" :key="b.id" class="text-gray-700">
                            ...
                            <td class="px-4 py-3 text-sm">
                                <img class="w-10 h-10" :src="'storage' + b.image" alt="book_image">
                            </td>
                            <td class="px-4 py-3 text-sm">
                                <!-- Boton view -->
                                <NavLink :href="route('books.show', b.id)">
                                    <SecondaryButton><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                            ...
                            <td class="px-4 py-3 text-sm">
                                <NavLink :href="route('books.edit', b.id)">
                                    <PrimaryButton><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
                                            <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <Modal :show="showModalDel" @close="closeModalDel">
            <div class="p-6">
                <p class="text-2xl font-medium text-gray-500">Are you sure delete to
                    <span class="text-2xl font-medium text-gray-900">{{ form.title }}</span>?
                </p>
            </div>
            <div class="m-6 flex justify-end">
                <div>
                    <DangerButton class="mr-2" @click="deleteBook">Yes, delete</DangerButton>
                </div>
