<template>
    <div class="relative text-gray-500 focus-within:text-blue-600">
        <input
            class="rounded block w-full pl-10 mt-1 text-sm text-black focus:border-blue-400 focus:outline-none focus:shadow-outline-blue form-input"
            :value="modelValue" @input="$emit('update:modelValue', $event.target.value)" ref="input" :placeholder="text"
            :type="type" :required="required" :accept="accept">
